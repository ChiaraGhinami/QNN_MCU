...
#ifndef TENSORFLOW_LITE_UTIL_FFNN_MODEL_DATA_H_
#define TENSORFLOW_LITE_UTIL_FFNN_MODEL_DATA_H_

extern const unsigned char FFNN_model[];
extern const int FFNN_model_len;

#endif  // TENSORFLOW_LITE_UTIL_FFNN MODEL_DATA_H_
